...
export default function Footer() {
  return (
    <main className='bg-[#212121] h-full md:h-60 py-8 flex-col md:flex-row flex items-start md:items-center justify-between md:px-4 lg:px-24 px-8 rounded-xl' id="footer">
      {/* Logo Section */}
      <div className='flex flex-col items-start justify-center'>
        <h1 className='text-white text-4xl font-bold flex items-center flex-row'>
          ...
          <span className='text-red-500'>BAD TALK</span>
        </h1>
        <p className='text-neutral-400 text-sm font-bold max-w-sm'>Lorem ipsum dolor sit, amet consectetur adipisicing. Lorem, ipsum dolor. Lorem, ipsum.</p>
      </div>
      ...
      <div className='flex gap-8 md:gap-4 xl:gap-28 md:px-4 xl:px-24 flex-row flex-wrap md:flex-nowrap items-start py-8 md:py-0'>
        ...
        <div className='flex flex-col items-start justify-center w-fit min-w-fit'>
          ...
          <nav className="flex justify-between h-auto flex-wrap items-center gap-6">
            <a href="https://www.instagram.com/bad.talks2024/" target="_blank" rel="noopener noreferrer" className="h-11 w-11 relative rounded-xl group text-white hover:text-white">
            ...
            <a href="https://chat.whatsapp.com/FYzPkqLqZ9v0vzBLSnuBm6" target="_blank" rel="noopener noreferrer" className="h-11 w-11 relative rounded-xl group text-white hover:text-white">
              <div className="h-full w-full absolute group-hover:bg-white/40 group-hover:backdrop-blur-sm transition-all duration-300 rounded-xl z-10 flex items-center justify-center">
            ...
            <a href="/" className="h-11 w-11 relative rounded-xl group text-white hover:text-white">
              <div className="h-full w-full absolute group-hover:bg-white/40 group-hover:backdrop-blur-sm transition-all duration-300 rounded-xl z-10 flex items-center justify-center">
