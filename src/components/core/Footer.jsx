...
export default function Footer() {
  return (
    <main className='bg-[#212121] h-full md:h-60 py-8 flex-col md:flex-row flex items-start md:items-center justify-between md:px-4 lg:px-24 px-8 rounded-xl'>
      {/* logo */}
     <div className='flex flex-col items-start justify-center'>
      ...
      <svg
        ...
        </div><span className='text-red-500'>BAD TALK</span>
      </h1>
     ...
     <div className='flex flex-col items-start justify-center w-fit min-w-fit '>
      ...
      <div className='text-white break-keep'>Quick links</div>
      </h1>
      <p className='text-neutral-400 text-sm font-bold max-w-sm'>Teams</p>
      <p className='text-neutral-400 text-sm font-bold max-w-sm'>Timeline</p>
     ...
     <div className='flex flex-col items-start justify-center w-fit min-w-fit'>
      ...
      <nav className="flex justify-between h-auto flex-wrap item-center gap-6">
          <a
            href="https://www.instagram.com/bad.talks2024/"
            target="_blank"
