...
export default function More() {
  return (
    <div>
        <main className='h-full md:h-fit mt-3 w-full flex flex-col justify-between gap-12 py-4 max-w-7xl mx-auto' id="bad">
    ...
    <p className='text-black lg:hidden md:text-2xl font-semibold'>Super Cool Swags</p>
            ...
            <div className='flex items-center justify-center gap-4 pl-8'>
            <div className='h-24 w-24 min-w-24 bg-black lg:absolute rounded-full -top-1/2 right-52 border flex items-center justify-center' > <img src={tshirt} className='rounded-full h-full w-full '  alt="image" />
