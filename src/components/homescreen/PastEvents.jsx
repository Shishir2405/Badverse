    ...
    return (
        <main className='h-full w-full  max-w-7xl mx-auto py-8'>
             <div className='relative w-fit mx-auto mb-16'>
                ...
                <h1 className='text-center font-bold text-5xl'>Past <span className='text-red-700'>Events</span></h1>
            </div>
        <section className='h-full w-full gap-12  flex flex-col
        min-[800px]:flex-row mx-auto py-12 px-4'>
            ...
            <div className='flex flex-1  flex-col items-end'>
                <div className='flex flex-col w-full min-[800px]:max-w-96 pt-3 pb-6'>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit voluptatibus voluptatem assumenda tempora accusantium doloremque omnis perspiciatis quidem </p>
                </div>
                <div className='aspect-[16/11]  w-full lg:w-96 bg-slate-700 rounded-2xl
                flex items-end
                p-4
                '>
                    <div className=' h-fit'>
                        <h4 className='font-semibold text-xl'>IPS ACADEMY</h4>
                        <p className='text-neutral-200 text-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit minus molestiae dolores temporibus ratione. molestiae dolores temporibus ratione.</p>
                    </div>
                </div>
