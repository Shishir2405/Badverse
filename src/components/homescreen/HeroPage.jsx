...
export default function HeroPage() {
  return (
    <main className='relative flex bg-[#212121] h-[97vh] z-10  rounded-xl'>
      ...
      <section className='flex flex-col  bg-[#212121] flex-1 h-[75vh] px-4 py-8 items-start justify-end  z-[100]'>
        ...
        <div className='absolute -top-[160px] min-[380px]:-top-[245px] min-[440px]:-top-[240px] min-[940px]:-top-[200px] xl:-top-[390px] left-12 min-[360px]:left-4  min-[440px]:-left-4 w-full h-full'>
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800"><defs><filter id="nnneon-filter" x="-100%" y="-100%" width="400%" height="400%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
	...
	<feGaussianBlur stdDeviation="10 17" x="0%" y="0%" width="100%" height="100%" in="SourceGraphic" edgeMode="none" result="blur"></feGaussianBlur></filter></defs><g stroke-width="17.5" stroke="hsl(353, 98%, 41%)" fill="none" transform="rotate(328, 400, 400)"><path d="M389.14103223963247 255.32842112942834C393.58978170614216 246.33884568239637 406.41022474933516 246.33884568239637 410.8589742158448 255.32842112942834L548.727804019874 533.9252988041978C552.7125363170826 541.977147647995 546.8535623464834 551.4137788012202 537.8700445648469 551.4137788012202H262.1299618906303C253.14644410899382 551.4137788012202 247.2874701383946 541.977147647995 251.27220243560328 533.9252988041978L389.14103223963247 255.32842112942834Z " filter="url(#nnneon-filter)"></path><path d="M401.14103223963247 255.32842112942834C405.58978170614216 246.33884568239637 418.41022474933516 246.33884568239637 422.8589742158448 255.32842112942834L560.727804019874 533.9252988041978C564.7125363170826 541.977147647995 558.8535623464834 551.4137788012202 549.8700445648469 551.4137788012202H274.1299618906303C265.1464441089938 551.4137788012202 259.2874701383946 541.977147647995 263.2722024356033 533.9252988041978L401.14103223963247 255.32842112942834Z " filter="url(#nnneon-filter2)" opacity="0.25"></path><path d="M377.14103223963247 255.32842112942834C381.58978170614216 246.33884568239637 394.41022474933516 246.33884568239637 398.8589742158448 255.32842112942834L536.727804019874 533.9252988041978C540.7125363170826 541.977147647995 534.8535623464834 551.4137788012202 525.8700445648469 551.4137788012202H250.12996189063028C241.14644410899382 551.4137788012202 235.2874701383946 541.977147647995 239.27220243560328 533.9252988041978L377.14103223963247 255.32842112942834Z " filter="url(#nnneon-filter2)" opacity="0.25"></path><path d="M389.14103223963247 255.32842112942834C393.58978170614216 246.33884568239637 406.41022474933516 246.33884568239637 410.8589742158448 255.32842112942834L548.727804019874 533.9252988041978C552.7125363170826 541.977147647995 546.8535623464834 551.4137788012202 537.8700445648469 551.4137788012202H262.1299618906303C253.14644410899382 551.4137788012202 247.2874701383946 541.977147647995 251.27220243560328 533.9252988041978L389.14103223963247 255.32842112942834Z "></path></g></svg>
          </div>
        </div>
        ...
        <div className='flex pl-2  gap-4  flex-col items-start justify-start'>
          <p className='text-white text-base max-w-xl z-40'>
            ...
            Lorem sum dolor sitametssd consectetur, adipisicing elit. Repudiandae eveniet delenitiillo maxime corrupti amet reprehenderit.
          </p>
          <button
            type="submit"
          ...
          >
            <p className='group-hover:text-white ease-linear duration-300  text-black '>Job & Internship..</p>
            <svg
      ...
      <section className='absolute flex h-44 z-[101] bg-[#121212] bottom-0 rounded-bl-xl pt-2 pr-2  w-[70vw]'>
        ...
        <div className='h-full w-full  gap-2 hidden md:flex'>
          ...
          <div className='bg-neutral-800 w-full flex-1 rounded-lg flex flex-col justify-center items-center '>
              <h3><span className='text-red-500 font-semibold text-xl'><Counter from={500} to={800} />+ </span> Startups</h3>
              <p className='text-center'><span className='text-red-500 font-semibold text-xl'><Counter from={300} to={500} />+ </span> Associated Companies</p>
          </div>
          <div className='bg-neutral-800 w-full flex-1 rounded-lg flex flex-col justify-center items-center '>
              <p><span className='text-red-500'>Ex</span>plore</p>
          </div>

        </div>
        </section>
        {/* left side */}
        <div className='w-8 h-4 absolute -top-4 left-0 bg-[#121212] z-10'><div className='w-full h-full absolute top-0 left-0 bg-[#212121] rounded-bl-xl' /> </div>
        {/* right side */}
        <div className='w-8 h-8 absolute top-0 right-0 bg-[#212121] z-10'><div className='w-full h-full absolute top-[0px] right-0 bg-[#121212] rounded-tr-xl' /> </div>
        {/* bottom side */}
        <div className='w-8 h-8 absolute bottom-0 -right-8 bg-[#121212] z-10'><div className='w-full h-full absolute bottom-0 left-0 bg-[#212121] rounded-bl-xl' /> </div>
      </section>
    </main>
  )
}
