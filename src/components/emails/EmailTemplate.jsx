  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <p>Thank you for registering for {event.title}. Your ticket has been confirmed.</p>
        
        <div style={{ backgroundColor: '#f8f9fa', padding: '15px', margin: '20px 0' }}>
          <h3>Event Details</h3>
        ...
        <div style={{ marginTop: '30px' }}>
          ...
          <p>For any queries, please contact us at support@badtalks.com</p>
        </div>
      </div>
      
      <div style={{ backgroundColor: '#f8f9fa', padding: '20px', textAlign: 'center', marginTop: '20px' }}>
        <p style={{ margin: '0', color: '#666' }}>© 2024 Bad Talks. All rights reserved.</p>
      </div>
    </div>
  );
};
